	...
	if (isLoadingSettings) {
		return (
			<div
				...
				role="status"
				aria-label="Loading TTS settings"
			>
		...
		<div className="tts-settings">
			...
			<div className="tts-settings__control">
				...
				<p className="tts-settings__help">
					Select the voice used for text-to-speech output during meditation
					sessions.
				</p>
			</div>
			...
			<div className="tts-settings__control">
				<label htmlFor="tts-rate-slider" className="tts-settings__label">
					Speed:{" "}
					<span className="tts-settings__value">
						{rateValue >= 0 ? `+${rateValue}%` : `${rateValue}%`}
					</span>
				</label>
			...
			<div className="tts-settings__control">
				<label htmlFor="tts-pitch-slider" className="tts-settings__label">
					Pitch:{" "}
					<span className="tts-settings__value">
						{pitchValue >= 0 ? `+${pitchValue}Hz` : `${pitchValue}Hz`}
					</span>
				</label>
				<div className="tts-settings__slider-container">
